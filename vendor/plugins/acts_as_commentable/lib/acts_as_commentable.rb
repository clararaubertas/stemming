    ...
    module Commentable #:nodoc:
      ...
      module ClassMethods
        def acts_as_commentable
          has_many :user_comments, :as => :commentable, :dependent => :destroy, :order => 'created_at ASC'
      ...
      module SingletonMethods
        ...
        # This method is NOT equivalent to UserComment.find_comments_for_user
